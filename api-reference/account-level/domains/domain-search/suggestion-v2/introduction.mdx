---
title: "About the Suggestion API"
description: "The Suggestion API allows you to retrieve suggestions for domains that are spot-on for your customers' sites."
icon: "file-lines"
---

The Suggestion API allows you to retrieve suggestions for domains that are
spot-on for your customers' sites.
