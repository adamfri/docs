---
title: "Introduction"
description: "The Pro Gallery API allows you to manage pro galleries on a Wix site's backend."
icon: "file-lines"
---
...
To learn more about how a site owner can do this using Velo, see [Displaying a Pro Gallery on Your Site Using the Pro Gallery Backend API](fallback::https://support.wix.com/en/article/velo-tutorial-displaying-a-pro-gallery-on-your-site-using-the-pro-gallery-backend-api).
...
+ Read more about how site owners can manage their [Pro Galleries](fallback::https://support.wix.com/en/article/wix-pro-gallery-about-the-wix-pro-gallery).
...
+ **Gallery Items:** Media items in a pro gallery, such as images, videos, and text files. You can read more about [supported media](fallback::https://support.wix.com/en/article/wix-pro-gallery-adding-media-to-the-gallery). 
