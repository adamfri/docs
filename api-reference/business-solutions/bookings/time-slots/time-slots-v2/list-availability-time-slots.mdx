      ...
      <Expandable title="customerChoices properties">
        ...
        <ParamField body="requestedGender" type="RequestedGenderValue">
          ...
          **Developer Preview.**
          ...
          <Expandable title="requestedGender properties">

            <ParamField body="gender" type="string">

              Gender the customer narrowed "any staff member" to.

              **Supported values:**

              - `ANY_MALE` — Any male staff member.
              - `ANY_FEMALE` — Any female staff member.
