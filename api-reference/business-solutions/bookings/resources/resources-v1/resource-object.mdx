...
description: "The Resource object in the Wix Resource API."
icon: "cube"
---
...
<ResponseField name="schedules" type="Schedule[]" deprecated>
          ...
          <Expandable title="constraints properties">
            ...
            <ResponseField name="slotsSplitInterval" type="SplitInterval">
              ...
              **Read-only.**
              ...
              _Nested structure omitted for brevity — see the `SplitInterval` object._
...
<ResponseField name="scheduleIds" type="string[]">
...
<ResponseField name="status" type="string">
  ...
  **Supported values:**
  ...
  - `UNDEFINED` — Undefined resource status.
