...
1. When the customer books on the Wix site, the [eCommerce checkout process](fallback::https://dev.wix.com/docs/rest/business-solutions/bookings/bookings/bookings-writer-v2/sample-booking-flows#part-2-handle-the-payment-process-with-wix-ecommerce-sdk--rest)
   sends a [Calculate Price](https://dev.wix.com/api/rest/wix-bookings/pricing-integration-spi/calculate-price) service plugin request, including the [booking object](fallback::https://dev.wix.com/docs/rest/business-solutions/bookings/bookings/bookings-writer-v2/booking-object), to your app. 
