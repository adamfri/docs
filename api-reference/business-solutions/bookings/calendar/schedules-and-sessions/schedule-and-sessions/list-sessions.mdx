---
title: "List Sessions"
description: "Returns multiple sessions from the calendar."
icon: "upload"
tag: "Deprecated"
mode: "wide"
searchable: false
...
<Warning>
  ...
  **Deprecated.** Use `wix.calendar.events.v3.EventsService.ListEvents` instead. Scheduled for removal on 2025-06-30.
...
```http
POST https://www.wixapis.com/bookings/v1/calendar/sessions/list
```
...
<ParamField body="fieldMask" type="FieldMask">
  ...
  Field mask of fields to return. Currently only supports the "scheduleOwnerId" field.
...
<ResponseField name="sessions" type="Session[]">
  ...
  <Expandable title="sessions properties">
