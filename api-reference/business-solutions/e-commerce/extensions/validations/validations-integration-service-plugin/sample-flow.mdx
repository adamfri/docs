...
2. Wix sends a [Get Validation Violations](https://dev.wix.com/api/rest/wix-ecommerce/validations-integration-spi/get-validation-violations) service plugin request to your app. 
...
When configuring your app, set the `validateInCart` property to `true` in the extension’s configuration file. This validates a site visitor's cart in addition to a site visitor's checkout. 
...
5. Again Wix sends a [Get Validation Violations](https://dev.wix.com/api/rest/wix-ecommerce/validations-integration-spi/get-validation-violations) service plugin request to your app. 
