---
title: "Introduction"
description: "Note: The Get Paid Invoice APIs aren't yet available for all sites."
icon: "file-lines"
---

<Note>

The Get Paid Invoice APIs aren't yet available for all sites. The APIs are available for new sites, and Wix is migrating existing sites. Calls for a site that Wix hasn't migrated yet fail with a `428` error. You don't need to do anything: migration enables access automatically.
...
- [Create an invoice with automatic charges](fallback::https://dev.wix.com/docs/api-reference/business-management/get-paid/invoices/invoices/sample-flows#create-an-invoice-with-automatic-charges)
