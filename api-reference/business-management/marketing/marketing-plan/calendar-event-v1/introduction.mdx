...
- [Query Events](fallback::https://dev.wix.com/docs/api-reference/business-management/marketing/marketing-plan/calendar-event-v1/query-events) also returns read-only events from the site's connected calendars (such as Google Calendar). These events can't be updated or deleted through this API.
