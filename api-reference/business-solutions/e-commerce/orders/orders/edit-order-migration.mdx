---
title: "Edit Order Migration"
description: "Notes: + This migration is relevant for all apps that currently use the Stores Orders API."
icon: "file-lines"
---
...
The webhook payload structure has also changed. To facilitate your move to these webhooks, have a look at the [webhook conversion table](##webhook-conversion-table*fallback::https://dev.wix.com/docs/rest/api-reference/wix-e-commerce/orders/order-object-conversion#webhook-conversion-table).
...
1. Go to your app in the [Wix Developers Center](fallback::https://dev.wix.com/).
...
1. Install the [EditThisCookie Chrome extension](fallback::https://chromewebstore.google.com/detail/editthiscookie/fngmhnnpilhplaeedifhccceomclgfbg?pli=1).
...
![editorder](https://wixmp-833713b177cebf373f611808.wixmp.com/images/appendices_docs_guides_images_edit-order.jpg)
...
5. Navigate to an [unfulfilled order in the dashboard](fallback::https://support.wix.com/en/article/wix-stores-fulfilling-store-orders).
