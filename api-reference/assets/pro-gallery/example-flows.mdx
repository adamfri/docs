---
title: "Example Flows"
description: "This article shares some possible use cases for your app, as well as an example flow that could support each one."
icon: "file-lines"
---
...
Make sure to include both the Wix media item IDs and the external media IDs in the mapping.
...
Ignore the resulting webhook, so you don’t create an endless loop of updates.
