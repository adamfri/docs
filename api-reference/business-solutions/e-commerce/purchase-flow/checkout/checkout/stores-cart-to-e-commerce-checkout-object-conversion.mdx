---
title: "Stores Cart to eCommerce Checkout Object Conversion"
description: "To help with migration to the eCommerce API, refer to the table below for differences between the Stores Cart and eCommerce Checkout objects."
icon: "file-lines"
---
