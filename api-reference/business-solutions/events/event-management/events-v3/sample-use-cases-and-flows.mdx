...
1. [Query Event Guests](fallback::https://dev.wix.com/docs/rest/business-solutions/events/event-guests/query-event-guests) by `eventId` of the events that are going to be cancelled.
...
1. On an ongoing basis, listen for the [Event Canceled Webhook](fallback::https://dev.wix.com/docs/rest/business-solutions/events/events-v3/event-canceled). 

1. [Bulk Cancel Events by Filter](fallback::https://dev.wix.com/docs/rest/business-solutions/events/events-v3/bulk-cancel-events-by-filter). Specify `categoryId` of the recurring events in the filter object to cancel all events.
...
1. [Query Event Guests](fallback::https://dev.wix.com/docs/rest/business-solutions/events/event-guests/query-event-guests) by `eventId`.
...
1. On an ongoing basis, listen for [Event Reminder Webhook](fallback::https://dev.wix.com/docs/rest/business-solutions/events/events-v3/event-reminder). 
