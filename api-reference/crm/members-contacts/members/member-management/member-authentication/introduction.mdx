---
title: "Introduction"
description: "The Members Authentication API allows your app to trigger an email that prompts a site member to set their password."
icon: "file-lines"
---
...
[import-member-flow]: https://dev.wix.com/docs/rest/crm/members-contacts/members/members/sample-use-cases-and-flows
