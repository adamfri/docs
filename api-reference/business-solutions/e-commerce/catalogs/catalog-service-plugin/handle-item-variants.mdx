---
title: "Handle Item Variants"
description: "This article explains how to handle item customization and variants when implementing the Catalog service plugin."
icon: "file-lines"
---
...
+ `appId`: ID of the app providing the catalog. You can get your app's ID from your [app's dashboard](fallback::https://dev.wix.com/apps).
