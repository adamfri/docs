---
title: "Introduction"
description: "<blockquote class='warning' Deprecation Notice: Schedules and Sessions has been replaced with Calendar V3 and will be removed on June 30, 2025."
icon: "file-lines"
---
...
[Calendar V3](fallback::https://dev.wix.com/docs/rest/business-management/calendar/introduction)
...
5. intervals.start = 2020-05-15T21:00:00Z [(Google Protobuf Timestamp format)](fallback::https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/timestamp)  
...
5. Call [Create Schedule](https://dev.wix.com/api/rest/wix-bookings/schedules-and-sessions/schedule/create-schedule) again to set the logic for the instructor's availability for 1-on-1 appointments of 60 minutes. Parameters to include:  
   ...
   d. schedule.availability.start = e.g.,2020-05-15T21:00:00Z [(Google Protobuf Timestamp format)](fallback::https://developers.google.com/protocol-buffers/docs/reference/csharp/class/google/protobuf/well-known-types/timestamp)  
