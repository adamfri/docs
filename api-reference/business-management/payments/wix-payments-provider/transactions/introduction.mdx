---
title: "Introduction"
description: "About the Transactions API Use Wix Payments server-to-server API integration to accept different payment methods and manage transactions."
icon: "file-lines"
---
...
to achieve the best approve ratio, the correct MIT/CIT flag must be passed as well.
