---
title: "Validate Before Cancel Multi Service"
description: "Validates whether a multi-service booking can be canceled."
icon: "upload"
tag: "Preview"
mode: "wide"
---
...
<Tabs>
  ...
  <Tab title="REST">
    ...
    Validates whether a multi-service booking can be canceled.

    Wix calls this method when a customer initiates a multi-service
    cancellation, before the bookings are canceled. Use this to enforce
    package-level cancellation rules.
    ...
    ```http
    POST /v1/validate-before-cancel-multi-service
    ```
    ...
    <ParamField body="multiServiceBookingInfo" type="MultiServiceContext">
      ...
      Information about the multi-service booking being canceled.
    ...
    <ResponseField name="singleServiceBookingResults" type="CancelValidationItemResult[]">
    ...
    <CodeGroup>
      ...
      ```bash Request
      curl -X POST \ 'https://provider.example.com/v1/validate-before-cancel-multi-service' \
      -H 'user-agent: Wix' \
  ...
  <Tab title="SDK">
    ...
    bookingsValidation.validateBeforeCancelMultiService(request, metadata): Promise
    ```

    ## Method Parameters

    <ParamField body="request" type="ValidateBeforeCancelMultiServiceRequest">
    ...
    <input type="radio" name="ex-sdk-validate-before-cancel-multi-service" id="ex-sdk-validate-before-cancel-multi-service-0" className="wix-picker-radio" defaultChecked />
    <input type="radio" name="ex-sdk-validate-before-cancel-multi-service" id="ex-sdk-validate-before-cancel-multi-service-1" className="wix-picker-radio" />
    <input type="radio" name="ex-sdk-validate-before-cancel-multi-service" id="ex-sdk-validate-before-cancel-multi-service-2" className="wix-picker-radio" />

    <input type="checkbox" id="ex-sdk-validate-before-cancel-multi-service-open" className="wix-picker-toggle" />

    <label htmlFor="ex-sdk-validate-before-cancel-multi-service-open" className="wix-picker-button">

    <span className="wix-picker-current"><span className="wix-picker-name">validateBeforeCancelMultiService</span></span>
    <span className="wix-picker-current"><span className="wix-picker-name">validateBeforeCancelMultiService (self-hosted)</span><span className="wix-picker-desc">Self-hosted SDK calls require you to [create a client](https://dev.wix.com/docs/sdk/articles/work-with-the-sdk/about-the-wix-client)</span></span>
    <span className="wix-picker-current"><span className="wix-picker-name">validateBeforeCancelMultiService (with elevated permissions)</span></span>

    </label>

    <div className="wix-picker-options">

    <label htmlFor="ex-sdk-validate-before-cancel-multi-service-0"><span className="wix-picker-name">validateBeforeCancelMultiService</span></label>
    <label htmlFor="ex-sdk-validate-before-cancel-multi-service-1"><span className="wix-picker-name">validateBeforeCancelMultiService (self-hosted)</span><span className="wix-picker-desc">Self-hosted SDK calls require you to [create a client](https://dev.wix.com/docs/sdk/articles/work-with-the-sdk/about-the-wix-client)</span></label>
    <label htmlFor="ex-sdk-validate-before-cancel-multi-service-2"><span className="wix-picker-name">validateBeforeCancelMultiService (with elevated permissions)</span></label>
    ...
    ```javascript validateBeforeCancelMultiService
    import { bookingsValidation } from '@wix/bookings/service-plugins';

    async function validateBeforeCancelMultiService(request,metadata) {
      const response = await bookingsValidation.validateBeforeCancelMultiService(request,metadata);
    };
    ```
    ...
    ```javascript validateBeforeCancelMultiService (self-hosted)
    ...
    async function validateBeforeCancelMultiService(request,metadata) {
      const response = await myWixClient.bookingsValidation.validateBeforeCancelMultiService(request,metadata);
    };
    ```
    ...
    ```javascript validateBeforeCancelMultiService (with elevated permissions)
    import { bookingsValidation } from '@wix/bookings/service-plugins';
    import { auth } from '@wix/essentials';

    async function myValidateBeforeCancelMultiServiceMethod(request,metadata) {
      const elevatedValidateBeforeCancelMultiService = auth.elevate(bookingsValidation.validateBeforeCancelMultiService);
      const response = await elevatedValidateBeforeCancelMultiService(request,metadata);
    }
    ```
