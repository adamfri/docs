...
<Tabs>
  ...
  <Tab title="REST">
    ...
    <ResponseField name="baseUri" type="SpiBaseUri">
      ...
      Base URI where the endpoints are called. Wix appends the endpoint path to the base URI. For example, to call the Run Tool endpoint at `https://my-tools.com/v1/run-tool`, the base URI you provide here is `https://my-tools.com`.
