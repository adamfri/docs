---
title: "Introduction"
description: "The Site Folders API enables the management of sites in an account by organizing them into folders."
icon: "file-lines"
---

The Site Folders API enables the management of sites in an account by organizing them into folders. 

![Site Folders](https://wixmp-833713b177cebf373f611808.wixmp.com/images/c86b0755cc63e61e73842db1113034c9.jpg)
...
This API is accessible via API keys, which are currently available to selected beta users only. You will not be able to access this API with a standard Auth header.

</Note>

Site owners and contributors can also manage their sites and folders via the [My Sites](fallback::https://manage.wix.com/account/sites) page.
