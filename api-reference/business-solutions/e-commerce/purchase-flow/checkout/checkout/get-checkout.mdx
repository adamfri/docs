...
<Tabs>
  ...
  <Tab title="REST">
    ...
    <Warning>
      ...
      **Deprecated.** Replaced by Cart V2 Get Cart. To re-evaluate prices, inventory, and discounts, use Refresh Cart. Use `wix.ecom.cart.v2.CartService.GetCart` instead. Scheduled for removal on 2027-02-01.
