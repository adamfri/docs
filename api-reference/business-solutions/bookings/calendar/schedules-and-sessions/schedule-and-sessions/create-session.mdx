...
<Warning>
  ...
  **Deprecated.** Use `wix.calendar.events.v3.EventsService.CreateEvent` instead. Scheduled for removal on 2025-06-30.
...
```http
POST https://www.wixapis.com/bookings/v1/calendar/sessions
```
...
<ParamField body="session" type="Session" required deprecated>
  ...
  **Deprecated.**
  ...
  <Expandable title="session properties">
    ...
    <ParamField body="start" type="CalendarDateTime" required>
    ...
    <ParamField body="end" type="CalendarDateTime" required>
