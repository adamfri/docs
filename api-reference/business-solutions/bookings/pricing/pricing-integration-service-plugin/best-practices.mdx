...
description: "This article presents some best practices for designing your pricing app for integration with Wix."
icon: "file-lines"
---
...
+ Make sure you are familiar with the [booking object](fallback::https://dev.wix.com/docs/rest/business-solutions/bookings/bookings/bookings-writer-v2/booking-object) and its properties. When you receive this object from Wix, you can retrieve the values necessary for calculating the price. For example: 
