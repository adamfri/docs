          ...
          <Expandable title="values properties">
            ...
            <ResponseField name="type" type="string">
              ...
              **Supported values:**
              ...
              - `DATE_TIME` — The price is resolved from rules based on when the service is booked
              (days and hours, months, or a date range).
              - `NUMBER_OF_PARTICIPANTS` — The price is resolved from rules based on the number of participants.
