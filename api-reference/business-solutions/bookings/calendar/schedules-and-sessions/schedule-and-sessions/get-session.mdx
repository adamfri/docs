---
title: "Get Session"
description: "Returns a session from the calendar."
icon: "download"
tag: "Deprecated"
mode: "wide"
searchable: false
...
<Warning>
  ...
  **Deprecated.** Use `wix.calendar.events.v3.EventsService.GetEvent` instead. Scheduled for removal on 2025-06-30.
...
```http
GET https://www.wixapis.com/bookings/v1/calendar/sessions/{id}
```
