...
<Tabs>
  ...
  <Tab title="REST">
    ...
    <ResponseField name="namespaceConfigs" type="FormsSubmissionsExtensionNamespaceConfig[]">

      Namespace names.

      Constraints: `maxItems 10`.

      <Expandable title="namespaceConfigs properties">
        ...
        <ResponseField name="submissionValidationEnabled" type="boolean">
