...
<Warning>
  ...
  **Deprecated.** Depending on your use case, you may also replace the method by using
  External Calendar V2 [List Events](https://dev.wix.com/docs/api-reference/business-solutions/bookings/calendar/external-calendar-v2/list-events). Use `wix.calendar.events.v3.EventsService.QueryEvents` instead. Scheduled for removal on 2025-06-30.
