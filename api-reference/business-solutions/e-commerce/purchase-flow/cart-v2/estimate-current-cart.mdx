---
title: "Estimate Current Cart"
description: "Estimates the customer's current cart totals based on its current state and the selected calculation components."
icon: "upload"
mode: "wide"
---
...
<Tabs>
  ...
  <Tab title="REST">
    ...
    ```http
    POST https://www.wixapis.com/ecom/v2/carts/current/estimate
    ```
  ...
  <Tab title="SDK">
    ...
    currentCartV2.estimateCurrentCart(options): Promise
    ```

    ## Method Parameters

    <ParamField body="options" type="EstimateCurrentCartOptions">
    ...
    <input type="radio" name="ex-sdk-estimate-current-cart" id="ex-sdk-estimate-current-cart-0" className="wix-picker-radio" defaultChecked />
    <input type="radio" name="ex-sdk-estimate-current-cart" id="ex-sdk-estimate-current-cart-1" className="wix-picker-radio" />

    <input type="checkbox" id="ex-sdk-estimate-current-cart-open" className="wix-picker-toggle" />

    <label htmlFor="ex-sdk-estimate-current-cart-open" className="wix-picker-button">

    <span className="wix-picker-current"><span className="wix-picker-name">Estimate current cart totals</span></span>
    <span className="wix-picker-current"><span className="wix-picker-name">estimateCurrentCart (self-hosted)</span><span className="wix-picker-desc">Self-hosted SDK calls require you to [create a client](https://dev.wix.com/docs/sdk/articles/work-with-the-sdk/about-the-wix-client)</span></span>

    </label>

    <div className="wix-picker-options">

    <label htmlFor="ex-sdk-estimate-current-cart-0"><span className="wix-picker-name">Estimate current cart totals</span></label>
    <label htmlFor="ex-sdk-estimate-current-cart-1"><span className="wix-picker-name">estimateCurrentCart (self-hosted)</span><span className="wix-picker-desc">Self-hosted SDK calls require you to [create a client](https://dev.wix.com/docs/sdk/articles/work-with-the-sdk/about-the-wix-client)</span></label>
    ...
    ```javascript Estimate current cart totals
    import { currentCartV2 } from "@wix/ecom";
    ...
    ```javascript estimateCurrentCart (self-hosted)
