---
title: "Estimate Cart"
description: "Estimates cart totals from the cart's current state and selected calculation components."
icon: "upload"
mode: "wide"
---
...
<Tabs>
  ...
  <Tab title="REST">
    ...
    Estimates cart totals from the cart's current state and selected calculation components.

    Provides a partial, component-based estimate for preview (for example, partial estimated totals).
    Boolean flags control which components are included: delivery costs, additional fees, taxes, and gift cards.
    Components that aren't enabled are excluded. Line item discounts are already applied to the cart.
    ...
    ```http
    POST https://www.wixapis.com/ecom/v2/carts/{cartId}/estimate
    ```
    ...
    <ParamField body="validationConfig" type="string">
    ...
    <ParamField body="calculateDelivery" type="boolean">
    ...
    <ParamField body="calculateGiftCards" type="boolean">
          ...
          <Expandable title="violations properties">
            ...
            <ResponseField name="code" type="string">
              ...
              **Supported values:**
              ...
              - `INVALID_MEMBERSHIP_STATUS` — A selected membership can't be used to pay for the cart. For example, the membership has
              ...
              - `SUBSCRIPTION_ITEM_NOT_SUPPORTED_ON_DEMO_CART` — A subscription item can't be purchased on a demo cart.
              - `GIFT_CARD_ITEM_NOT_SUPPORTED_ON_DEMO_CART` — A gift card item can't be purchased on a demo cart.
              - `GIFT_CARD_PAYMENT_NOT_SUPPORTED_ON_DEMO_CART` — A gift card can't be used to pay on a demo cart.
              - `MEMBERSHIP_PAYMENT_NOT_SUPPORTED_ON_DEMO_CART` — A membership can't be used to pay on a demo cart.
    ...
    Estimates cart totals for the requested calculation components.

    <CodeGroup>

      ```bash Request
      curl -X POST \
      'https://www.wixapis.com/ecom/v2/carts/ca727402-f531-4bcf-ab09-db70ea0bd008/estimate' \
      -H 'Authorization: <AUTH>' \
      -H 'Content-Type: application/json' \
      -d '{
        "calculateTax": true,
        "calculateAdditionalFees": true
      }'
      ```
  ...
  <Tab title="SDK">
    ...
    cartV2.estimateCart(cartId, options): Promise
    ```
    ...
    <ParamField body="options" type="EstimateCartOptions">
    ...
    <input type="radio" name="ex-sdk-estimate-cart" id="ex-sdk-estimate-cart-0" className="wix-picker-radio" defaultChecked />
    <input type="radio" name="ex-sdk-estimate-cart" id="ex-sdk-estimate-cart-1" className="wix-picker-radio" />

    <input type="checkbox" id="ex-sdk-estimate-cart-open" className="wix-picker-toggle" />

    <label htmlFor="ex-sdk-estimate-cart-open" className="wix-picker-button">

    <span className="wix-picker-current"><span className="wix-picker-name">Estimate cart totals</span></span>
    <span className="wix-picker-current"><span className="wix-picker-name">estimateCart (self-hosted)</span><span className="wix-picker-desc">Self-hosted SDK calls require you to [create a client](https://dev.wix.com/docs/sdk/articles/work-with-the-sdk/about-the-wix-client)</span></span>

    </label>

    <div className="wix-picker-options">

    <label htmlFor="ex-sdk-estimate-cart-0"><span className="wix-picker-name">Estimate cart totals</span></label>
    <label htmlFor="ex-sdk-estimate-cart-1"><span className="wix-picker-name">estimateCart (self-hosted)</span><span className="wix-picker-desc">Self-hosted SDK calls require you to [create a client](https://dev.wix.com/docs/sdk/articles/work-with-the-sdk/about-the-wix-client)</span></label>
    ...
    ```javascript Estimate cart totals
    import { cartV2 } from "@wix/ecom";

    async function estimateCart() {
      const response = await cartV2.estimateCart(
        "ca727402-f531-4bcf-ab09-db70ea0bd008",
        { calculateTax: true, calculateAdditionalFees: true },
      );
    }
    ...
    ```javascript estimateCart (self-hosted)
    ...
    async function estimateCart(cartId,options) {
      const response = await myWixClient.cartV2.estimateCart(cartId,options);
    };
    ```
