...
<Warning>
  ...
  **Deprecated.** Use `wix.calendar.events.v3.EventsService.UpdateEvent` instead. Scheduled for removal on 2025-06-30.
...
```http
PATCH https://www.wixapis.com/bookings/v1/calendar/sessions/{session.id}
```
...
<ParamField body="session" type="Session" required deprecated>
  ...
  **Deprecated.**
  ...
  <Expandable title="session properties">
    ...
    <ParamField body="originalStart" type="datetime">
    ...
    <ParamField body="start" type="CalendarDateTime">
      ...
      <Expandable title="start properties">
        ...
        <ParamField body="localDateTime" type="LocalDateTime">

          An object containing the local date and time for the business's time zone.

          _Nested structure omitted for brevity — see the `LocalDateTime` object._
    ...
    <ParamField body="end" type="CalendarDateTime">
    ...
    <ParamField body="timeReservedAfter" type="integer">
    ...
    <ParamField body="recurringIntervalId" type="string">
    ...
    <ParamField body="recurringSessionId" type="string">
    ...
    <ParamField body="instanceOfRecurrence" type="string">
    ...
    <ParamField body="version" type="Version">
...
<ParamField body="updated" type="FieldMask">
...
<ResponseField name="session" type="Session" deprecated>
