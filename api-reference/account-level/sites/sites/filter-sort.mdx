---
title: "Filter & Sort"
description: "Filter Both the Query Sites and Count Sites endpoints accept the following filters: id folderId filter sites that are in root level (no folder): filter sites t…"
icon: "file-lines"
---
