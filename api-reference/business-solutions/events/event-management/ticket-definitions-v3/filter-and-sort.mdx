...
description: "The following table shows field support for filters and sorting for the Ticket Definition object: | Field | Query Filter Operators | Sortable | |--------------…"
icon: "file-lines"
---
...
[Ticket Definitions Query endpoint](https://dev.wix.com/docs/rest/business-solutions/events/ticket-definition-v3/query-ticket-definitions)
