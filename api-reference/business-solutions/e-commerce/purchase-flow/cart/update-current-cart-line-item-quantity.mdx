...
<Tabs>
  ...
  <Tab title="REST">
    ...
    <Warning>
      ...
      **Deprecated.** Replaced by Cart V2 Update Line Items In Current Cart. Use `wix.ecom.cart.v2.CurrentCartService.UpdateLineItemsInCurrentCart` instead. Scheduled for removal on 2027-02-01.
