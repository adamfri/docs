...
description: "Disputes Overview The dispute process involves the following parties: 1."
icon: "file-lines"
---
...
![Dispute lifecycle](https://wixmp-833713b177cebf373f611808.wixmp.com/images/disputes-md_wixpay-services_api_transactions_proto_docs_new_dispute_lifecycle.png "Dispute lifecycle")
...
![Evidence Upload](https://wixmp-833713b177cebf373f611808.wixmp.com/images/disputes-md_wixpay-services_api_transactions_proto_docs_evidence_upload.png "Evidence Upload")
...
The evidence still needs to be associated with the relevant dispute after upload.
