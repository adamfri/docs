---
title: "Introduction"
description: "The Sites API is a service that holds public information about Wix sites that is accessible to the site's owner, including the site's name, its URL, its publis…"
icon: "file-lines"
---
...
This API is accessible only when authenticated as a Wix user or by using an account level API key.
