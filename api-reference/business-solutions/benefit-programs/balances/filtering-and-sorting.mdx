...
description: "The following table shows field support for filters and sorting for the balance object: | Field | Supported Filters | Sortable | | ------------------------- |…"
icon: "file-lines"
---
...
[Query Balances](fallback::https://dev.wix.com/docs/rest/business-solutions/benefit-programs/balances/query-balances).
