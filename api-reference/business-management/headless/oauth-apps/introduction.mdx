---
title: "Introduction"
description: "The OAuth Apps API enables you to manage OAuth apps for a Wix Headless project or site."
icon: "file-lines"
---
...
To use Wix Headless functionality you need to create an OAuth app, either using the OAuth Apps API or in the project or site's [dashboard](fallback::https://www.wix.com/my-account/site-selector/?buttonText=Select%20Site&title=Select%20a%20Site&autoSelectOnSingleSite=true&actionUrl=https:%2F%2Fwww.wix.com%2Fdashboard%2F%7B%7BmetaSiteId%7D%7D%2Foauth-apps-settings). For instructions on how to do this, see how to [set up authorization](https://dev.wix.com/docs/go-headless/getting-started/setup/authorization/authorization-strategies) for Wix Headless.
...
+ [Connect a custom template on any platform to an existing Wix project](##auth-management_oauth-apps_sample-flows_connect-a-custom-template-on-any-platform-to-an-existing-wix-project*fallback::https://dev.wix.com/api/rest/auth-management/oauth-apps/sample-flows#auth-management_oauth-apps_sample-flows_connect-a-custom-template-on-any-platform-to-an-existing-wix-project)
+ [Change allowed redirect domains for an external client app or site](##auth-management_oauth-apps_sample-flows_change-allowed-redirect-domains-for-an-external-client-app-or-site*fallback::https://dev.wix.com/api/rest/auth-management/oauth-apps/sample-flows#auth-management_oauth-apps_sample-flows_change-allowed-redirect-domains-for-an-external-client-app-or-site)
+ [Prevent an existing client app or site from connecting to a Wix project](##auth-management_oauth-apps_sample-flows_prevent-an-existing-client-app-or-site-from-connecting-to-a-wix-project*fallback::https://dev.wix.com/api/rest/auth-management/oauth-apps/sample-flows#auth-management_oauth-apps_sample-flows_prevent-an-existing-client-app-or-site-from-connecting-to-a-wix-project)
