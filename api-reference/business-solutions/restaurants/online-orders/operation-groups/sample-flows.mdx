---
title: "Sample Flows"
description: "⚠ This file is an example only ⚠ Replace the content with your own sample flows, following the prompts here."
icon: "file-lines"
---
...
> [Sample Flow Article](fallback::https://wix-private.github.io/tw-cafe/style-guide/api-documentation-guidelines/intro-articles/sample-flow-article).
>
...
## Periodically export new OperationGroups to an external ____
...
you can export new OperationGroups to an external _____.
...
1. For the first load after the app is installed, use
  [Query OperationGroups](fallback::&lt;link_to_OperationGroups>)
  to get all OperationGroups.
  Set `paging.limit` to 1000.

    If you receive 1,000 OperationGroups, _____.

2. Upload the returned OperationGroups to the external _____.
...
4. For all subsequent loads, use
  [Query OperationGroups](fallback::&lt;link_to_OperationGroups>),
  and filter for new OperationGroups created since the last load:
