...
<Tabs>
  ...
  <Tab title="REST">
    ...
    <ParamField body="booking" type="Booking" deprecated>
      ...
      **Deprecated.** Existing [booking](https://dev.wix.com/docs/rest/business-solutions/bookings/bookings/bookings-writer-v2/introduction) to calculate the base price for.
      Must include `bookedEntity` details and participant information. Use `bookings` instead. Removal: 2027-02-25.
      ...
      <Expandable title="booking properties">
        ...
        <ParamField body="multiServiceBookingInfo" type="MultiServiceBookingInfo">
  ...
  <Tab title="SDK">
    ...
    pricing.calculatePrice(options): Promise<CalculatePriceResponse>
    ```

    ## Method Parameters

    <ParamField body="options" type="CalculatePriceOptions">
          ...
          <Expandable title="booking properties">
            ...
            <ParamField body="multiServiceBookingInfo" type="MultiServiceBookingInfo">
              ...
              **Read-only.**
              ...
              _Nested structure omitted for brevity — see the `MultiServiceBookingInfo` object._
    ...
    async function calculatePrice(options) {
      const response = await myWixClient.pricing.calculatePrice(options);
    };
    ```
